...
const colorClasses: Record<string, { bg: string; text: string; border: string; glow: string }> = {
  cyan: { bg: "bg-cyan-500/20", text: "text-cyan-400", border: "border-cyan-500/40", glow: "hover:shadow-[0_0_20px_rgba(34,211,238,0.25)]" },
  emerald: { bg: "bg-emerald-500/20", text: "text-emerald-400", border: "border-emerald-500/40", glow: "hover:shadow-[0_0_20px_rgba(52,211,153,0.25)]" },
  purple: { bg: "bg-purple-500/20", text: "text-purple-400", border: "border-purple-500/40", glow: "hover:shadow-[0_0_20px_rgba(168,85,247,0.25)]" },
  amber: { bg: "bg-amber-500/20", text: "text-amber-400", border: "border-amber-500/40", glow: "hover:shadow-[0_0_20px_rgba(251,191,36,0.25)]" },
};
          ...
          {tools.map((tool) => {
            ...
            return (
              <Link
                ...
                href={tool.href}
                className={cn(
                  "group relative overflow-hidden rounded-xl border bg-slate-900/40 p-8 backdrop-blur-sm transition-all duration-300",
                  "hover:-translate-y-1",
                  colors.border,
                  colors.glow
                )}
